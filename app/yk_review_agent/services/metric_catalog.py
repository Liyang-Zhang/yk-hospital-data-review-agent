...
METRICS: tuple[MetricDefinition, ...] = (
    ...
    MetricDefinition(
        ...
        supported_products=("PGT-SR",),
        supported_filters=("hospital_id", "hospital_name", "time_range", "patient_age_range", "spouse_age_range", "sr_clinical_type", "sr_translocation_pair"),
        supported_breakdowns=("overall", "month", "quarter", "day", "age", "sr_clinical_type", "sr_translocation_pair"),
        supported_time_grains=("overall", "month", "quarter", "day"),
        ...
        default_chart_type="bar",
        chart_goal="trend",
        example_questions=("看一下 PGT-SR 的整倍体率", "按月看一下 PGT-SR 整倍体率变化", "按临床指征看一下 PGT-SR 胚胎整倍体率", "平衡易位患者按 t(1;5) 这种类型看一下胚胎整倍体率", "t(1;5) 的 PGT-SR 胚胎整倍体率是多少"),
        route_priority=60,

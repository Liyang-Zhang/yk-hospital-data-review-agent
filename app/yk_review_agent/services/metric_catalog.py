...
METRICS: tuple[MetricDefinition, ...] = (
    MetricDefinition(
        ...
        business_terms=("送检量", "周期数", "胚胎数", "送检情况", "趋势"),
        ...
        route_priority=70,
        hard_terms=("送检量", "送检情况", "多少周期", "多少胚胎"),
        soft_terms=("周期数", "胚胎数", "平均囊胚数"),
        aliases=("volume",),
    ...
    MetricDefinition(
        ...
        disambiguation_notes=("按年龄分层时应优先落到年龄分层整倍体率。",),
    ),
    MetricDefinition(
        metric_id="pgta_age_distribution",
        title="PGT-A 年龄分层整倍体率",
        description="按年龄分层统计周期数、胚胎数和整倍体率",
        supported_products=("PGT-A",),
        supported_filters=("hospital_id", "hospital_name", "time_range", "age_range"),
        supported_breakdowns=("age",),
        supported_time_grains=("overall", "month", "quarter"),
        business_terms=("年龄", "年龄分层", "高龄"),
        data_requirements=("female_age", "result_label", "cycle_id", "sample_id"),
        unsupported_combinations=("qc",),
        default_card_types=("summary", "table", "chart"),
        default_chart_type="bar",
        chart_goal="comparison",
        example_questions=("按年龄分层看一下 PGT-A 的整倍体率",),
        route_priority=30,
        hard_terms=("年龄分层", "按年龄"),
        soft_terms=("高龄", "年龄段"),
        aliases=("age_distribution",),
        disambiguation_notes=("年龄范围筛选本身不等于年龄分层。",),
    ),
    MetricDefinition(
    ...
    MetricDefinition(
        ...
        route_priority=10,
        hard_terms=("周期无整倍体", "周期整倍体率", "周期结局", "仅1个整倍体", ">=2个整倍体", "≥2个整倍体", "无整倍体且含有仅嵌合"),
        soft_terms=("周期整倍体",),

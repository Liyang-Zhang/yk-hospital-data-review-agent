...
METRICS: tuple[MetricDefinition, ...] = (
    ...
    MetricDefinition(
        ...
        title="PGT-SR 结果分布",
        description="统计未见异常、异常、嵌合异常和质控不合格分布",
        supported_products=("PGT-SR",),
        supported_filters=("hospital_id", "hospital_name", "time_range", "patient_age_range", "spouse_age_range", "sr_clinical_type"),
        supported_breakdowns=("overall", "month", "quarter", "day", "result"),
        supported_time_grains=("overall", "month", "quarter", "day"),
        business_terms=("结果分布", "结果结构", "嵌合", "异常", "未见异常"),
        data_requirements=("result_label", "review_time", "hospital"),
        unsupported_combinations=("qc",),
        default_card_types=("summary", "table", "chart"),
        default_chart_type="bar",
        ...
        route_priority=50,
        hard_terms=("结果分布", "结果结构", "嵌合", "异常", "未见异常"),
        soft_terms=("嵌合异常",),
    ),
    MetricDefinition(
        metric_id="pgtsr_cycle_indicator_overview",
        title="PGT-SR 周期结局总览",
        description="统计周期是否存在未见异常胚胎，以及不同 SR 临床类型的周期结局差异",
        supported_products=("PGT-SR",),
        supported_filters=("hospital_id", "hospital_name", "time_range", "patient_age_range", "spouse_age_range", "sr_clinical_type"),
        supported_breakdowns=("overall", "month", "quarter", "sr_clinical_type"),
        supported_time_grains=("overall", "month", "quarter"),
        business_terms=("周期结局", "周期整倍体率", "周期无整倍体", "按临床指征", "罗氏易位", "平衡易位", "倒位"),
        ...
        route_priority=10,
        hard_terms=("周期结局", "周期整倍体率", "周期无整倍体", "按临床指征", "罗氏易位", "平衡易位", "倒位"),
        soft_terms=("从周期角度", "按周期看", "不同SR患者"),
        aliases=("cycle_outcome",),
    ),
    MetricDefinition(
